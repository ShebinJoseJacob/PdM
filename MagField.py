#program to read magnetic field from motor
import uuid
...
norm_datasource_topic1 = '/v1/users/{user_id}/in/devices/{device_id}/datasources/ALERTS/MAGNETIC_FIELD_NORM/'.format(user_id=user_id,device_id=device_id)#data alerts
